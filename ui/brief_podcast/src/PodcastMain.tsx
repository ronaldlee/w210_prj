...
function App() {
  ...
  return (
    <>
<div className="w-full h-[932px] p-2.5 bg-stone-500 flex-col justify-center items-center gap-2.5 inline-flex">
    <div className="w-[375px] h-[812px] relative bg-white rounded-[32px]">
        ...
        <div className="w-[375px] h-[101px] left-0 top-[711px] absolute">
            ...
            <div className="w-[315px] h-[43px] left-[30px] top-[16px] absolute rounded-bl-[32px] rounded-br-[32px] justify-between items-center inline-flex">
